    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="graphs", to="knowledge.knowledgedocument"
                    ),
                ),
                (
                    "extraction_cache",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(help_text="Display name as found in source", max_length=255),
                ),
                (
                    "canonical_name",
                    models.CharField(
                ...
                (
                    "confidence",
                    models.FloatField(help_text="Extraction confidence score, 0.0 to 1.0"),
                ),
                (
                    "mention_count",
                    models.PositiveIntegerField(
                        default=1, help_text="Number of distinct mentions across chunks"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "passage_excerpt",
                    models.TextField(help_text="Relevant text fragment from the chunk"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "chunk",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "temporal_start_year",
                    models.IntegerField(
                        blank=True, help_text="Parsed start year for range queries", null=True
                    ),
                ),
                (
                    "temporal_end_iso",
                    models.CharField(
                        blank=True, help_text="Original temporal reference for end", max_length=100
                    ),
                ),
                (
                    "temporal_end_year",
                    models.IntegerField(
                        blank=True, help_text="Parsed end year for range queries", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="citations",
                        to="knowledge.knowledgerelation",
                    ),
                ),
            ],
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["graph", "entity_type"], name="knowledge_k_graph_i_eb33db_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="knowledgenode",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["graph", "relation_type"], name="knowledge_k_graph_i_1b7c5d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="knowledgerelation",
            index=models.Index(
                fields=["source_node", "target_node"], name="knowledge_k_source__63b4c4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="knowledgerelation",
            index=models.Index(
                fields=["temporal_start_year", "temporal_end_year"],
                name="knowledge_k_tempora_c829c8_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="knowledgerelationcitation",
