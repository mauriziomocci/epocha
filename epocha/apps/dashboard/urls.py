...
urlpatterns = [
    ...
    path(
        "simulations/<int:sim_id>/report/", views.simulation_report_view, name="simulation-report"
    ),
    path("simulations/<int:sim_id>/inject/", views.inject_event_view, name="inject-event"),
    path(
        "simulations/<int:sim_id>/chat/<int:agent_id>/history/",
        views.chat_history_api,
        name="chat-history-api",
    ),
    path(
        "simulations/<int:sim_id>/chat/<int:agent_id>/send/",
        views.chat_send_api,
        name="chat-send-api",
    ),
    ...
    path(
        "simulations/<int:sim_id>/analytics/data/", views.analytics_data_view, name="analytics-data"
    ),
    # Knowledge graph
    path(
        "simulations/<int:sim_id>/knowledge-graph/",
        knowledge_views.knowledge_graph_view,
    ...
    path(
        "simulations/<int:sim_id>/graph/agent/<int:agent_id>/",
        views.graph_agent_detail_view,
        name="graph-agent-detail",
    ),
]
