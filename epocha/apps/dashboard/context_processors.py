...
LANGUAGES = {
    ...
    "it": {
        ...
        "ui": {
            ...
            "mood": "Umore",
            "wealth": "Ricchezza",
            "live_activity": "Attivita' in tempo reale",
            "no_activity": "Nessuna attivita'. Premi Play per iniziare.",
            "inject_event": "Inietta Evento",
            "event_title": "Titolo evento",
            "what_happens": "Cosa succede...",
            "severity": "Gravita'",
            "select_agent": "Seleziona un agente per chattare",
            "say_something": "Scrivi qualcosa a",
            "send": "Invia",
            "group": "Gruppo",
            "select_participants": "Seleziona partecipanti:",
            "select_all": "Seleziona tutti",
            "say_to_group": "Scrivi qualcosa al gruppo...",
            "back": "Torna alle simulazioni",
            "play": "Avvia",
            "pause": "Pausa",
            "report": "Rapporto",
            "targeting": "verso",
    ...
    "fr": {
        ...
        "ui": {
            ...
            "mood": "Humeur",
            "wealth": "Richesse",
            "live_activity": "Activite en direct",
            "no_activity": "Aucune activite. Appuyez sur Play.",
            "inject_event": "Injecter Evenement",
            "event_title": "Titre",
            "what_happens": "Que se passe-t-il...",
            "severity": "Gravite",
            "select_agent": "Selectionnez un agent pour discuter",
            "say_something": "Dites quelque chose a",
            "send": "Envoyer",
            "group": "Groupe",
            "select_participants": "Selectionnez les participants:",
            "select_all": "Tout selectionner",
            "say_to_group": "Dites quelque chose au groupe...",
            "back": "Retour aux simulations",
            "play": "Jouer",
            "pause": "Pause",
            "report": "Rapport",
            "targeting": "ciblant",
    ...
    "de": {
        ...
        "ui": {
            ...
            "mood": "Stimmung",
            "wealth": "Vermogen",
            "live_activity": "Live-Aktivitat",
            "no_activity": "Keine Aktivitat. Druecken Sie Play.",
            "inject_event": "Ereignis einfugen",
            "event_title": "Titel",
            "what_happens": "Was passiert...",
            "severity": "Schwere",
            "select_agent": "Agent zum Chatten auswahlen",
            "say_something": "Schreibe etwas an",
            "send": "Senden",
            "group": "Gruppe",
            "select_participants": "Teilnehmer auswahlen:",
            "select_all": "Alle auswahlen",
            "say_to_group": "Schreibe etwas an die Gruppe...",
            "back": "Zuruck zu Simulationen",
            "play": "Start",
            "pause": "Pause",
            "report": "Bericht",
            "targeting": "Ziel",
    ...
    "es": {
        ...
        "ui": {
            ...
            "no_activity": "Sin actividad. Pulsa Play para empezar.",
            "inject_event": "Inyectar Evento",
            "event_title": "Titulo",
            "what_happens": "Que sucede...",
            "severity": "Gravedad",
            "select_agent": "Selecciona un agente para chatear",
            "say_something": "Escribe algo a",
            "send": "Enviar",
            "group": "Grupo",
            "select_participants": "Selecciona participantes:",
            "select_all": "Seleccionar todos",
            "say_to_group": "Escribe algo al grupo...",
            "back": "Volver a simulaciones",
            "play": "Iniciar",
            "pause": "Pausa",
            "report": "Informe",
