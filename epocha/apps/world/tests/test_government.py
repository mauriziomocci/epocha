...
class TestUpdateIndicators:
    ...
    def test_repression_drifts_toward_type_tendency(
        self, simulation, world, government, all_institutions
    ):
...
class TestTransitions:
    def test_democracy_to_illiberal_on_low_trust_high_repression(
        self, simulation, world, government, all_institutions
    ):
    ...
    def test_no_transition_when_stable(self, simulation, world, government, all_institutions):
        ...
        government.save(
            update_fields=["institutional_trust", "popular_legitimacy", "repression_level"]
        )
        result = check_transitions(simulation)
    ...
    def test_coup_succeeds_when_conditions_met(
        self, simulation, world, government, all_institutions, faction_with_leader
    ):
