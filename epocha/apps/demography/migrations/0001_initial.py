    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "couple_type",
                    models.CharField(
                        choices=[("monogamous", "Monogamous"), ("arranged", "Arranged")],
                        default="monogamous",
                        max_length=20,
                    ),
                ),
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["simulation", "dissolved_at_tick"],
                        name="demography__simulat_136c13_idx",
                    ),
                    models.Index(
                        fields=["agent_a", "dissolved_at_tick"],
                        name="demography__agent_a_ddd879_idx",
                    ),
                    models.Index(
                        fields=["agent_b", "dissolved_at_tick"],
                        name="demography__agent_b_557390_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("separate", "Separate"),
                            ("migration", "Migration"),
                            ("inheritance_transfer", "Inheritance transfer"),
                            ("mass_flight", "Mass flight"),
                            ("trapped_crisis", "Trapped crisis"),
                            ("demographic_initializer", "Demographic initializer"),
                        ],
                        max_length=30,
                    ),
                ),
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["simulation", "tick"], name="demography__simulat_c21689_idx"
                    ),
                    models.Index(
                        fields=["simulation", "event_type", "tick"],
                        name="demography__simulat_fcd720_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["simulation", "tick"], name="demography__simulat_dccb44_idx"
                    )
                ],
