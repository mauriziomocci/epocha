...
- [SESSION RESUME 2026-06-13](project_session_resume_2026_06_13.md) -- READ FIRST: Branch 5 factions CHIUSO (PR#9, merge 5406b95, frozen-pin b1986a2, develop HEAD b1986a2). Split 11+5 eseguito, audit CONVERGED, §4.7 promosso EN+IT. F-CAMPAIGN: solo Branch 6 (world economy deprecation) rimasto. Nuovi work item: ruff cleanup + factions Round 3 hardening. Nota: gh aliasato a git hist (usare /opt/homebrew/bin/gh).
- [Ruff cleanup pending](project_ruff_cleanup_pending.md) -- NUOVO work item: ruff check . esce 1 su develop (1185 errori/150 file, CI lint gate rosso). Spec Kit dedicato per ripristinare gate verde.
