...
- [SESSION RESUME (agg. 2026-07-17)](project_session_resume_2026_07_15.md) -- Economy base layer CHIUSO: CONVERGED round 12, promosso a par. 4.8, MERGIATO in develop (merge SHA 368e972, PR#14), frozen-pin risolto, suite 911 verdi. Residuo par. 8 = solo 8.1 Knowledge Graph. Frontiera: cablaggio demografia Plan 4 + audit KG. Gli handoff di sessione sono stati rimossi a lavoro chiuso.
- [Economy: decisioni ratificate](project_economy_ratified_decisions.md) -- NON RILITIGARE. Le scelte di modello ratificate nei 12 round di audit dell'economia (partizione approccio A, depositi fuori da M, Carli documentato non sostituito, interesse bancario = sink, lien, default_settled, Fisher income-velocity, R12-DET-1 fuori scope, anchor non-economia pinnati ai loro commit). Se un audit futuro le ri-solleva, sono deliberate.
