...
- [SESSION RESUME 2026-05-16 factions](project_session_resume_2026_05_16_factions.md) -- READ FIRST: Branch 5 factions IN FLIGHT. Spec Kit docs autorate (HEAD 0c1ecd7), Round 2 audit NOT CONVERGED 16 findings (4 R1 OPEN + 12 NEW, 4× spec ceiling). ESCALAZIONE utente necessaria per split 11 in-branch + 5 deferred Round 3 hardening spec.
