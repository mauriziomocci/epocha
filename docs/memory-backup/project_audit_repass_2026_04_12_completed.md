...
2. **I conteggi di stato nel whitepaper degradano a ogni promozione.** A fine campagna il conteggio "moduli pendenti in paragraph 8" era stale in 7 punti tra EN e IT (tre valori diversi: tre, quattro, due) con factions omesso dagli elenchi dei convergiti; l'EN paragraph 11 diceva "four" dove l'IT diceva "tre". Lezione operativa: ogni promozione paragraph 8 -> paragraph 4 deve includere un grep di coerenza sul conteggio in ENTRAMBE le lingue (gate tipo SC-004 del branch 6), non solo l'edit della sezione promossa.
