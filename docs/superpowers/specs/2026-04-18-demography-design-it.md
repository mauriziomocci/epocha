...
**Il valore odierno del codice (0,3 come `default` quando la chiave manca) cessa di essere raggiungibile** per effetto di A9: la chiave diventa obbligatoria e validata.
