...
- **Falconer & Mackay (1996), pagine**: il libro non è stato aperto. RETTIFICA DEL 2026-08-11: questo punto affermava che la somiglianza fra parenti è materia del capitolo 10; non lo è. Il progetto cita ora l'intervallo di capitoli 8-10 e **omette deliberatamente i titoli**, perché tre round consecutivi del gate di fase 6 ne hanno colto uno sbagliato ciascuno. I numeri sono verificati sull'indice della quarta edizione, le pagine no, e A1 non vi poggia.
