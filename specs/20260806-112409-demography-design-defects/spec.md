...
- **SC-015** *(copre FR-014)*: il caricatore respinge, nominando il campo, un template con una chiave di primo livello inventata, uno con una **sezione annidata** obbligatoria mancante, e uno con un valore fuori intervallo. Verificato che oggi respinge una sezione di primo livello mancante ma accetta tutti e tre gli altri casi: il criterio deve nominare il livello di annidamento, altrimenti non fallisce contro il codice attuale.
