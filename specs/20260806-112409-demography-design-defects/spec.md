...
- **SC-002b** *(verifica d'integrazione, affianca SC-002a)* — l'ampiezza stazionaria realizzata cade fra il 95% e il 105% del bersaglio, sul bersaglio **non corretto** `s_T`, su **almeno 5.000 individui per generazione** e otto generazioni. La numerosità è vincolante: a 200 individui il modello **corretto** cade fuori banda 13 volte su 40, a 1.000 due volte, a 5.000 mai. I rami a un genitore e senza genitori sono sotto-popolazioni rare e vanno verificati su **popolazioni sintetiche costruite per quel ramo**. Il bersaglio non va corretto per la correlazione fra i genitori: correggerlo rende il criterio insoddisfacibile dal modello corretto al pavimento della regione ammissibile.
